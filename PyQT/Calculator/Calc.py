...
class Calc(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.add_btn(QPushButton('1'), 1, 0, 1, 1)
        self.add_btn(QPushButton('2'), 1, 1, 1, 1)
        self.add_btn(QPushButton('3'), 1, 2, 1, 1)
        self.add_btn(QPushButton('+'), 1, 3, 1, 1)
        self.add_btn(QPushButton('C'), 1, 4, 1, 1, lambda: self.display.setText(''), 'background: grey;')
        ...
        self.add_btn(QPushButton('='), 4, 2, 1, 1, self.eval_igual)
    ...
    def eval_igual(self):
        try:
            ...
            self.display.setText("Invalid Value.")
